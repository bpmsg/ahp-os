...
/** Methods */
    ...
    */
    public function modifyLum($rgb, $fac)
    {
        $hsl = array(0,0,0);
        $hsl = rgbToHsl($rgb);
    ...
    * @return string $rgb modified color as "#RRGGBB"
    */
    public function setColor($rgb, $dh, $ds, $dl)
    {
        $hsl = array(0,0,0);
    ...
    * @return string $rgb modified color as "#RRGGBB"
    */
    public function modifyColor($rgb, $dh, $ps, $pl)
    {
        $hsl = array(0,0,0);
        $hsl = $this->rgbToHsl($rgb);
        $hsl[0] = min(max($hsl[0] + $dh, 0), 360);
    ...
    * add: -steps to darken!
    */
    public function lumScale($rgbBaseColor, $steps)
    {
        $lumSc = array();
    ...
    * add: -steps to darken!
    */
    public function hueScale($rgbBaseColor, $rgbEndColor, $steps)
    {
        $hueSc = array();
        $hslBase= array(0,0,0);
        $hslEnd = array(0,0,0);
    ...
    public function lumMap($v, $rgbBaseColor)
    {
        $steps = count($v);
        if ($steps <2) {
            return $rgbBaseColor;
    ...
    */
    public function hueMap($v, $rgbBaseColor, $rgbEndColor)
    {
        $steps = count($v);
