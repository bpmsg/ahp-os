...
class AhpNewsPT
{
    ...
    public $info = array(
    "news1"		=>	"<p>Fizemos uma grande atualização do sistema de base de dados interno AHP-OS. 
						A base de dados Sqlite anterior foi substituído por uma base de dados SQL completa MariaDB, 
						uma vez que o número de utilizadores e projetos está a aumentar de forma constante. Por favor, 
						resmaem, caso enfrente algum problema ou descubra um bug.</p>
						<p>Além disso, foram feitas algumas melhorias de código e alterações editoriais, uma vez que 
