...
public $info = array(
	"contact"	=>	"<p>
								Sinta-se à vontade para deixar um
								<a href='%s'>comentário</a> 
								ou curtir/compartilhar este site.
								</p>",
	"intro11"	=>	"<div class='entry-content'><p style='text-align:justify;'>
								...
								Os programas podem ser úteis em seu trabalho diário para problemas de decisão simples e também apoiar complexos problemas de tomada de decisão. Participe de uma sessão de grupo e experimente <a href='https://bpmsg.com/participate-in-an-ahp-group-session-ahp-practical-example/'>para exemplos práticos</a>. 
								...
								Para obter a funcionalidade completa, você precisa fazer o login. Por favor <a href='includes/login/do/do-register.php'>faça seu cadastro</a> 
	...
	"intro12"	=>	"<ol style='line-height:150%;'>
								...
								<li><span style='cursor:help;' 
								title='A calculadora de prioridade AHP calcula prioridades ou pesos para um conjunto de critérios com base em comparações de pares' >
	...
	"intro21"	=> "<h3>Introduction</h3>
								...
								AHP refere-se ao <i> Processo Analítico Hierárquico</i>. É um método para apoiar tomada de decisão segundo critérios múltiplos, e foi originalmente desenvolvido pelo Prof. Thomas L. Saaty. AHP deriva de<i>escalas de comparação</i> de comparações emparelhadas de critérios e permite algumas pequenas inconsistências em julgamentos. As entradas podem ser medidas reais, mas também opiniões subjetivas. Como resultado,
								<i>prioridades</i> (weightings) e <i> razões de consistência </i> serão calculadas.
 								 Internacionalmente, o AHP é usado em uma ampla gama de aplicações, por exemplo, para avaliação de fornecedores, na gestão de projetos, no processo de contratação ou na avaliação de desempenho da empresa. </p></div>",

	"intro22"	=>"	<div style='display:block;clear:both;'>
								<h3>Benefícios do AHP</h3>
								<p style='text-align:justify;'>
								Usar o AHP como ferramenta de apoio para a tomada de decisão ajudará a obter <i>ma visão melhor em problemas de decisão complexos</i>. Como você precisa estruturar o problema de forma hierárquica, ele o força a pensar sobre o problema, considerar possíveis critérios de decisão e selecionar
