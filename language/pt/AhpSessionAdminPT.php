...
class AhpSessionAdminPT
{
    ...
    'pStat1'        => "Status do projeto alterado para ",
    'pStatO'        => "Aberto.",
    'pStatC'        => "Encerrado.",
    ...
    'usrStat1'      => "<p class='msg'><small>AHP-OS tem <span class='res'>%s</span> Usuários cadastrados, ",
