...
class AhpNewsEN
{
    ...
    public $info = array(
    "news1"		=>	"<p>We have made a major update of the AHP-OS internal database system. The previous <i>Sqlite</i> database
					was replaced by a full blown SQL database <i>MariaDB</i>, as the number of useres and projects is increasing
					steadily. Please feedback, in case you face any problems or discover a bug.</p>
					<p>In addition, some code improvements and editorial changes have been made, as I am planning to make the whole 
