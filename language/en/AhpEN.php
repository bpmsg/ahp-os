...
class AhpEN
{
    ...
    public $info = array(
    'contact'    =>    "<p>
                        Please feel free to leave a <a href='%s'>comment</a>.</p>",
    ...
    'intro23'    =>"    <h3>Method</h3>
                        ...
                        an Eigenvalue problem. The results of the pair-wise comparisons are arranged in a matrix. 
                        The first (dominant) normalized right Eigen vector of the matrix gives the ratio scale (weighting), the 
                        Eigenvalue determines the consistency ratio.
                        </p>",
