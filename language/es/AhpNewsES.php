...
public $info = array(
  "news1"   =>  "<p>Hemos realizado una importante actualización del sistema
				   ...
				   de usuarios y proyectos está aumentando firmemente. Por favor, comentarios, 
				   en caso de que tenga algún problema o descubra un error.</p> 
				   <p>Además, se han realizado 
				   algunas mejoras en el código y cambios editoriales, ya que estoy planeando hacer el 
