...
class AhpNewsDE
{
    ...
    "h2welc"		=>	"<h2>Wilkommen %s!</h2>",
    "h3release"		=>	"<h3>AHP-OS Release %s (%s)</h3>",
    "h3news2"		=>	"<h3>AHP-OS in anderen Sprachen</h3>",
    "h3don"			=>	"<h3>Deine Spende</h3>"
);
    ...
    public $info = array(
    "news1"		=>	"<p>AHP-OS wurde upgedated auf eine neue Datenbank. Anstatt der vorher verwendeten <i>Sqlite</i> Datenbank,
					wird jetzt <i>MariaDB</i> genutzt. Das war notwendig, da die Zahl der User und Projekte ständig steigt.
    ...
    "don"		=>	"<p>Bevor du anfängst: Wenn du ein aktiver Nutzer bist und/oder das Programm dir gefällt,
								...
								Ich habe laufende Kosten fürs Webhosting, Zertifikat, Spamfilter <i>etc.</i>, und möchte   
 								AHP-OS trotzdem für alle Nutzer umsonst anbieten. Bitte hilf mit einer Spende. 
 								Mit einer Spende bleibt dein Account aktiv über eine Periode von 3 Monaten hinaus, auch
								ohne Reaktivierung.</p>"
);
}
