    ...
    public function __construct($dbname = DBNAME){
        ...
        if (isset($_GET['logout'])) {
            ...
            if (isset($_POST["user_edit_submit_name"])) {
                ...
                $this->editUserPassword($_POST['user_password_old'], 
        ...
        // if user just submitted a login form
            ...
            $this->loginWithPostData($_POST['user_name'], 
				$_POST['user_password'], $_POST['user_rememberme']);
        }
        ...
        if (isset($_POST["request_password_reset"]) && isset($_POST['user_email'])) {
            ...
            $this->editNewPassword($_POST['user_name'], 
 ...
 */
    private function loginWithPostData($user_name, $user_password, $user_rememberme) {
        ...
        // user_name and non-empty user_password
            ...
            } else if (($result_row->user_failed_logins >= 3) 
                    ...
                    if (password_needs_rehash(
                        ...
                        = $this->db_connection->prepare(
							"UPDATE users 
							 ...
							 WHERE user_id = :user_id;");
                        $query_update->bindValue(':user_password_hash', 
							$user_password_hash, PDO::PARAM_STR);
                        $query_update->bindValue(':user_id', 
							$result_row->user_id, PDO::PARAM_INT);
        ...
        if (empty($user_password_new) || empty($user_password_repeat) || empty($user_password_old)) {
            ...
            if (isset($result_row->user_password_hash)) {
                ...
                if (password_verify($user_password_old, $result_row->user_password_hash)) {
                    ...
                    $user_password_hash 
						= password_hash($user_password_new, 
						  PASSWORD_DEFAULT, array('cost' => $hash_cost_factor));
 ...
 */
    public function editNewPassword($user_name, $user_password_reset_hash, 
