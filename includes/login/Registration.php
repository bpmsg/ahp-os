...
class Registration
{
    public const PWLENGTH =  6;  // minimum password length
    public const NLENMIN =   2;  // min user name length
    public const NLENMAX =  64;  // max user name length
    public const EMLENGTH = 64;  // max email length
